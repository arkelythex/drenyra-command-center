...
**FEOS Alignment:** [Foundation README](./README.md)
...
## Stack vs FEOS Planes

Cada capa del stack canónico se asigna a uno o más planos FEOS:
...
- [FEOS Index](../00-INDEX.md) — mapa maestro de documentación
- [Foundation README](./README.md) — navigation de docs fundacionales
...
- [Architecture Design](../14-design/README.md) — documentos de arquitectura detallada
- [Fiscal Intelligence Platform](../14-design/fiscal-intelligence-platform.md) — arquitectura del sistema
