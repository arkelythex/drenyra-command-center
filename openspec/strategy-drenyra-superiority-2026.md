...
> **Nota — Drenyra Dominion Program:** la estrategia se ejecuta bajo el programa federado **Drenyra Dominion** (master + SDDs verticales), que fija autoridad, contratos, dependencias, gates y waves de todo el ecosistema. El Command Center es la proyección Web UI profesional del Core y el **producto insignia de la wave 3** (SDD-050 cierre mensual, SDD-060 multi-operador, SDD-100 Command Center). Ver [programa maestro](https://github.com/arkelythex/drenyra-ai/tree/main/openspec/programs/drenyra-dominion).
