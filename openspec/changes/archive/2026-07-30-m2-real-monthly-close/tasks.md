...
- [x] **TASK-0.1**: Add `snapshot`, `steps`, `blockers`, `current_step` columns (JSONB on existing mission — no migration needed). <!-- sdd-owner: implementation -->
  - **Complexity**: S
...
- [x] **TASK-0.2**: Add `correction_of` column to `journal_entries`. <!-- sdd-owner: implementation -->
  - **Complexity**: S
...
[x] TASK-1.7: PR1 bounded review (parent gate)
- **Complexity**: S
- **Files**: All PR1 files
...
[x] TASK-2.11: PR2 bounded review (parent gate)
- **Complexity**: S
...
[x] TASK-3.7: Checklist auto-population from mission steps (deferred to M3)
- **Complexity**: M
- **Files to modify**:
  - `packages/application/src/use-cases/monthly-close/monthly-close-orchestrator.ts`
- **Dependencies**: PR2 complete
...
[x] TASK-3.8: SSE progress events during pipeline execution (delegated to IntentHandler callback)
- **Complexity**: M
- **Files to modify**:
  - `packages/application/src/use-cases/monthly-close/monthly-close-orchestrator.ts`
...
[x] TASK-3.10: API routes (reuses existing M1 routes via IntentHandler)
- **Complexity**: M
- **Files to modify**:
...
[x] TASK-3.11: PR3 bounded review (parent gate)
- **Complexity**: S
