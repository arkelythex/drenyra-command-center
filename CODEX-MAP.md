...
| `packages/drenyra-orchestrator` | drenyra-orchestrator | [DEPRECATED] Use @drenyra/agents instead. | ai, agents | — |
| `packages/drenyra-harness` | drenyra-harness | [DEPRECATED] Use @drenyra/agents instead. | ai, governance | — |
