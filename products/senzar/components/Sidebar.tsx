		...
		<aside className="w-20 lg:w-64 flex-none bg-white border-r border-gray-200 flex flex-col justify-between py-6 hidden md:flex h-full">
			<nav className="flex flex-col gap-2 px-3">
				...
				>
					<Icon
						name="dashboard"
						className={currentScreen === "dashboard" ? "filled" : ""}
					/>
				...
				<div className={linkClass("audit")} onClick={() => onNavigate("audit")}>
					<Icon
						...
						className={currentScreen === "audit" ? "filled" : ""}
					/>
				...
				<div
					className={linkClass("logistics")}
					onClick={() => onNavigate("logistics")}
				>
					<Icon
						name="local_shipping"
						className={currentScreen === "logistics" ? "filled" : ""}
					/>
				...
				>
					<Icon
						name="assignment"
						className={currentScreen === "reports" ? "filled" : ""}
					/>
			...
			<div className="px-3">
				...
				>
					<Icon
						name="settings"
						className={currentScreen === "settings" ? "filled" : ""}
					/>
