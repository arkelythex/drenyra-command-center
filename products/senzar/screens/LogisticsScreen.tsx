    ...
    <div className="flex flex-1 flex-col lg:flex-row overflow-hidden bg-gray-50 h-full">
      ...
      <div className="w-full lg:w-[400px] flex-none bg-white border-r border-gray-200 flex flex-col h-full z-10 shadow-sm">
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <div className="flex-1 bg-green-50 p-3 rounded-lg border border-green-100">
              ...
              <span className="text-xs text-green-600 font-medium">En Planta</span>
            </div>
            <div className="flex-1 bg-orange-50 p-3 rounded-lg border border-orange-100">
              <span className="block text-2xl font-bold text-orange-700">1</span>
              <span className="text-xs text-orange-600 font-medium">Retrasado</span>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className={`p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer group transition-colors ${i === 1 ? 'bg-blue-50/50 border-l-4 border-l-functional-blue' : 'border-l-4 border-l-transparent'}`}>
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3 className="font-bold text-gray-900">Volvo FH-12</h3>
                  <p className="text-xs text-gray-500 font-mono">PLACA: V1T-88{i}</p>
                </div>
                <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${i === 3 ? 'bg-orange-100 text-orange-700' : 'bg-green-100 text-green-700'}`}>
              ...
              <div className="w-full bg-gray-200 rounded-full h-1.5 mt-2">
                <div className="bg-functional-blue h-1.5 rounded-full" style={{width: `${80 - (i * 10)}%`}}></div>
              </div>
              <div className="flex justify-between mt-1">
                <span className="text-[10px] text-gray-400">Origen: Fundo San José</span>
                <span className="text-[10px] text-gray-400">Destino: Puerto Paita</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="flex-1 relative bg-gray-200 flex flex-col">
        {/* Mock Map Background */}
        <div className="absolute inset-0 bg-[#e5e7eb]" style={{backgroundImage: "radial-gradient(#cbd5e1 2px, transparent 2px)", backgroundSize: "30px 30px"}}>
          {/* Simulated Route Line */}
          <svg className="absolute inset-0 w-full h-full pointer-events-none">
            <path d="M 200 400 Q 400 300 600 200 T 900 150" fill="none" stroke="#2F80ED" strokeWidth="4" strokeDasharray="8 4" className="animate-[dash_20s_linear_infinite]" />
            <circle cx="200" cy="400" r="8" fill="#6f9b69" stroke="white" strokeWidth="2" />
            <circle cx="900" cy="150" r="8" fill="#F2994A" stroke="white" strokeWidth="2" />
          </svg>
          ...
          <div className="absolute top-[280px] left-[450px] transform -translate-x-1/2 -translate-y-1/2">
             <div className="relative">
               ...
               <div className="absolute top-12 left-1/2 -translate-x-1/2 bg-white px-3 py-1 rounded shadow-md whitespace-nowrap z-20">
                 ...
                 <p className="text-[10px] text-green-600 font-bold">Temperatura: 14°C</p>
               </div>
             </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur rounded-xl shadow-lg border border-gray-200 p-6">
          <div className="flex flex-col md:flex-row gap-8 items-center justify-between">
            <div className="flex items-center gap-4">
               ...
               <div>
                 <p className="text-sm text-gray-500 font-medium uppercase tracking-wide">Cadena de Frío</p>
                 <div className="flex items-baseline gap-2">
                   <h3 className="text-3xl font-bold text-gray-900">14.2°C</h3>
                   <span className="text-sm font-bold text-green-600 flex items-center"><Icon name="check_circle" className="text-sm mr-1" /> Óptimo</span>
                 </div>
               </div>
            </div>
            ...
            <div className="flex-1 w-full">
              <div className="flex justify-between items-end mb-2">
                 <div>
                   <p className="text-sm font-bold text-gray-900">Entrega Estimada</p>
                   <p className="text-xs text-gray-500">Puerto Paita - Muelle 4</p>
                 </div>
                 <div className="text-right">
                   <p className="text-xl font-bold text-functional-blue">14:30 PM</p>
