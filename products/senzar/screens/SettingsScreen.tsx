				...
				<div className="flex flex-col gap-6">
					...
					<section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
						...
						<div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div className="space-y-2 md:col-span-2">
								...
								<input
									type="text"
									defaultValue="Carr. Panamericana Norte Km 1040, Piura"
									className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
								/>
							</div>
						</div>
						<div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end">
							<button className="px-4 py-2 bg-slate-900 text-white rounded-lg font-bold text-sm hover:bg-slate-800 transition-colors">
								Guardar Cambios
							</button>
						</div>
					</section>
					...
					<section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
						<div className="p-6 border-b border-gray-200 flex justify-between items-center">
							<div>
								...
								<p className="text-sm text-gray-500">
									Gestión de datos en campo sin conexión.
								</p>
							</div>
								...
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-xs text-gray-500">
											Detectar pérdida de señal y guardar localmente
										</p>
									</div>
								</div>
							...
							<div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-xs text-gray-500">
											Cada 15 minutos en segundo plano
										</p>
									</div>
								</div>
					...
					<section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
						<div className="p-6 border-b border-gray-200">
							...
							<p className="text-sm text-gray-500">
								Alertas de incidencias y cambios de estado.
							</p>
						</div>
						<div className="divide-y divide-gray-100">
							{[
								"Alertas de Plagas",
								"Cambios de Temperatura Críticos",
								"Documentos Aprobados por SENASA",
							].map((item, idx) => (
								<div
									key={idx}
