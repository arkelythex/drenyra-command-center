...
export const AVAILABLE_MODELS = [
	...
	},
	{
		id: "llama3.3:70b",
		name: "Llama 3.3 70B",
		description: "Large model, requires 32GB+ RAM",
		provider: "ollama",
		baseUrl: "http://localhost:11434",
	},
	{
		id: "qwen2.5:latest",
		name: "Qwen 2.5 7B",
		description: "Alibaba's model, good for Chinese",
		provider: "ollama",
		baseUrl: "http://localhost:11434",
	},
	{
	...
	// ========== Groq ==========
	{
		...
		name: "Llama 3.3 70B",
		description: "via Groq (ultra-fast)",
		provider: "groq",
		baseUrl: "https://api.groq.com/openai/v1",
	},
	{
	...
	},
	{
		...
		description: "Reasoning enhanced",
		provider: "deepseek",
		baseUrl: "https://api.deepseek.com",
	},
	...
	// ========== Custom ==========
	{
		id: "custom-model",
		name: "Custom Model",
		description: "Enter your model ID",
		provider: "custom",
		baseUrl: "http://localhost:8000",
	},
];
		...
		updateSetting: async <K extends keyof Settings>(
			...
			if (key === "model" && typeof value === "string") {
				...
				if (
					currentModel &&
					newModel &&
					settings().baseUrl === currentModel.baseUrl
				) {
