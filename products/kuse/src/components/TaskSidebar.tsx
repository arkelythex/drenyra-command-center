...
import type { Task } from "../lib/tauri-api";
	...
	return (
		<aside class="task-sidebar">
			...
			<div class="sidebar-footer">
				<button class="footer-btn primary-btn" onClick={props.onSkillsClick}>
					Skills
				</button>
				<button class="footer-btn primary-btn" onClick={props.onMCPClick}>
					MCPs
				</button>
