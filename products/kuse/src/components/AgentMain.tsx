...
const AgentMain: Component<AgentMainProps> = (props) => {
	...
	const isInConversation = () =>
		props.activeTask !== null && props.messages.length > 0;
	...
	const handleSubmit = (e: Event) => {
		...
		const projectPath =
			selectedPaths().length > 0 ? selectedPaths().join(",") : undefined;
						...
						<Show
							...
							fallback={
								<div class="empty-state">
									<h2>Agent Mode</h2>
									<p>
										Describe a task and the agent will create a plan and execute
										it step by step.
									</p>
