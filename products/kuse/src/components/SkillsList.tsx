...
import { getSkillsList, type SkillMetadata } from "../lib/tauri-api";
	...
	return (
		<div class="skills-list">
			<div class="skills-header">
				...
				<p>
					Skills enhance Claude's ability to process specific file types and
				...
				<Show
					...
					fallback={
						<div class="skills-empty">
							...
							<p>
								Skills will be automatically detected from the app data
								directory
							</p>
							<div class="skills-help">
								...
								<ol>
									<li>
										Skills are stored in the app data directory for better
										compatibility
									</li>
									<li>
										On first run, skills are automatically migrated from
										~/.kuse-cowork/skills/
									</li>
									<li>
									...
									<li>
										Skills include PDF, DOCX, XLSX, and PPTX processing
										capabilities
									</li>
									<li>
										Skills are automatically mounted in Docker containers at
										/skills
									</li>
								</ol>
							</div>
				...
				<div class="skill-modal-overlay" onClick={() => setSelectedSkill(null)}>
					<div class="skill-modal" onClick={(e) => e.stopPropagation()}>
						...
						<div class="skill-modal-content">
							<p>
								<strong>Location:</strong> App data directory/skills/
								{selectedSkill()}/
							</p>
							<p>
								<strong>Files:</strong>
							...
							<p>
								<strong>Usage:</strong> Skills are automatically available to
								Claude when processing relevant file types.
							</p>
							<p>
								<strong>Platform paths:</strong>
							</p>
							<ul>
								<li>
