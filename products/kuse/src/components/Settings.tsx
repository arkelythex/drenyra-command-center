			...
			<div class="settings-content">
				...
				<div class="settings-section">
					...
					<Show when={!isNoAuthProvider()}>
						<div class="form-group">
							...
							<input
								...
								placeholder={
									currentProviderInfo()?.authType === "bearer"
										? "sk-..."
										: "your-api-key"
								}
							/>
								...
								<Show
									...
									fallback={
										<Show
											...
											fallback={
												<>Get API Key from {currentProviderInfo()?.name}</>
											}
										>
					...
					<div class="form-group">
						...
						<input
							...
							placeholder={
								currentProviderInfo()?.baseUrl || "https://api.example.com"
							}
						/>
						<span class="hint">
							{isNoAuthProvider()
					...
					<Show when={currentProviderInfo()?.id === "openai"}>
						<div class="form-group">
							...
							/>
							<span class="hint">
								Your OpenAI organization ID (if you belong to multiple
								organizations)
							</span>
						</div>
					...
					<div class="form-group">
						...
						<input
							...
							onInput={(e) =>
								updateSetting(
									"maxTokens",
									parseInt(e.currentTarget.value, 10) || 4096,
								)
							}
							min={1}
							max={200000}
				...
				<div class="settings-section">
					...
					<p class="hint" style={{ margin: 0 }}>
						...
						<br />
						API key is securely stored and never sent to any server except
						Anthropic's API.
					</p>
				</div>
			</div>
