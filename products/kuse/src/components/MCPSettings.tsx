...
const MCPSettings: Component<MCPSettingsProps> = (props) => {
	...
	const [editingServer, setEditingServer] =
		createSignal<MCPServerConfig | null>(null);
				...
				{showAddForm() && (
					<div class="add-form">
						...
						<div class="form-group">
							...
							<input
								...
								onInput={(e) =>
									setFormData((prev) => ({
										...prev,
										serverUrl: e.currentTarget.value,
									}))
								}
								...
								<div class="form-group">
									...
									<input
										...
										onInput={(e) =>
											setFormData((prev) => ({
												...prev,
												oauthClientId: e.currentTarget.value,
											}))
										}
								...
								<div class="form-group">
									...
									<input
										...
										onInput={(e) =>
											setFormData((prev) => ({
												...prev,
												oauthClientSecret: e.currentTarget.value,
											}))
										}
						...
						<div class="warning-text">
							<strong>Security Notice:</strong> Only use connectors from
							developers you trust. MCP servers have access to tools and data as
							configured, and this app cannot verify that they will work as
							intended or that they won't change.
						</div>
