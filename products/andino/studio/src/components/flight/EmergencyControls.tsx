...
export default function EmergencyControls({ onAction }: { onAction: (action: string) => void }) {
  return (
    <div className="p-3 bg-bg-void/50">
      <h3 className="text-xs font-semibold text-text-muted uppercase tracking-wider mb-3">Emergency Controls</h3>
