...
import type { Telemetry, AgentEvent } from "@/types/drone";
import { mockTelemetry, mockAgentEvents } from "@/lib/mock-data";
import HUD from "./HUD";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col h-[calc(100vh-52px)]">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-bold text-text-primary">Flight Dashboard</h1>
