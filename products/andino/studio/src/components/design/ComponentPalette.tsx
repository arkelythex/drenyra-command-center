...
const categories: PaletteCategory[] = [
	{
		...
		icon: <Box size={16} />,
		items: [
			{ label: "Quad", detail: "4 arms" },
			{ label: "Y6", detail: "6 arms, coaxial" },
			{ label: "X8", detail: "8 arms, coaxial" },
			{ label: "Hexa", detail: "6 arms" },
	...
	},
	{
		...
		items: [
			{ label: "2207", detail: "1960KV" },
			{ label: "4010", detail: "480KV" },
			{ label: "501S", detail: "320KV" },
			{ label: "6010", detail: "280KV" },
		],
	},
	{
		name: "Propellers",
		...
		items: [
			{ label: "6x3.5", detail: '6" dia' },
			{ label: "10x4.5", detail: '10" dia' },
			{ label: "13x4.5", detail: '13" dia' },
			{ label: "15x5", detail: '15" dia' },
		],
	},
	{
		name: "Batteries",
		...
		items: [
			{ label: "4S 4200", detail: "15.4V" },
			{ label: "6S 10000", detail: "22.2V" },
