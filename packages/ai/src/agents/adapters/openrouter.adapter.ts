...
export class OpenRouterAdapter {
   ...
   */
  async complete(messages: OpenRouterMessage[], modelOverride?: string): Promise<AIResponse> {
...
Provide validation results in JSON format.`,
  ...
  private async callOpenRouterAPI(messages: OpenRouterMessage[], model: string): Promise<OpenRouterCompletionResponse> {
