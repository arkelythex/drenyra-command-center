...
/**
 * Create a DelegationGraph pre-populated with ARKELYTHEX fiscal agents.
 * Used by ArkelythexHarness when no external graph is provided.
 *
 ...
 * Used by ArkelythexHarness when no external workflow is provided.
 *
...
export function createArkelythexHarness(
