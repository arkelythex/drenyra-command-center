/**
 * CivicCase DTO — Output of CivicCase commands/queries
 */
import { z } from "zod";
...
export type FraudIndicatorItemDTO = z.infer<typeof FraudIndicatorDTOSchema>;
...
export type CivicCaseDTO = z.infer<typeof CivicCaseDTOSchema>;
