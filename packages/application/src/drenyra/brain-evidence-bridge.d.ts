...
export declare function toFiscalTruthScope(scope: DrenyraFiscalScope): FiscalTruthScope;
export declare function createDrenyraBrainEvidenceBridge(deps: DrenyraBrainEvidenceBridgeDeps): DrenyraBrainEvidenceBridge;
