export type ReportType = "BALANCE_GENERAL" | "ESTADO_RESULTADOS" | "BALANCE_COMPROBACION" | "LIBRO_MAYOR";
...
export interface ReportDataSource extends BalanceReportDataSource, LedgerReportDataSource, OrganizationReportDataSource, OpeningBalanceDataSource {
}
export declare class FinancialReportsService {
    ...
    generateTrialBalance(organizationId: number, period: ReportPeriod): Promise<TrialBalanceReport>;
    generateBalanceSheet(organizationId: number, period: ReportPeriod): Promise<BalanceSheetReport>;
    generateIncomeStatement(organizationId: number, period: ReportPeriod): Promise<IncomeStatementReport>;
    generateGeneralLedger(organizationId: number, period: ReportPeriod, accountCodes?: string[]): Promise<GeneralLedgerReport>;
}
