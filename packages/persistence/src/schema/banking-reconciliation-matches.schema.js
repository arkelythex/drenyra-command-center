...
export const reconciliationShadowRuns = pgTable('reconciliation_shadow_runs', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    companyCreatedIdx: index('reconciliation_shadow_runs_company_created_idx').on(table.companyId, table.createdAt),
}));
export const transactionReconciliationMatchesRelations = relations(transactionReconciliationMatches, ({ one }) => ({
...
export const partialPaymentTransactionsRelations = relations(partialPaymentTransactions, ({ one }) => ({
