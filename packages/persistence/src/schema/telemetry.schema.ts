/**
 * Frontend telemetry schema: error tracking, web vitals, events, pageviews.
 */
import {
	decimal,
	index,
...
export const frontendTelemetryEvents = pgTable(
	...
	(t) => ({
		...
		eventTimestampIdx: index("frontend_telemetry_event_ts_idx").on(
			t.eventTimestamp,
		),
