import { decimal, index, integer, jsonb, pgTable, text, timestamp, uuid, varchar, } from "drizzle-orm/pg-core";
...
export const businessPartners = pgTable("business_partners", {
    ...
    sunatCondition: varchar("sunat_condition", { length: 50 }).default("HABIDO"),
...
export const customerProfiles = pgTable("customer_profiles", {
    ...
    customerSegmentIdx: index("customer_profiles_segment_idx").on(t.customerSegment),
    paymentScoreIdx: index("customer_profiles_payment_score_idx").on(t.paymentBehaviorScore),
}));
