/**
 * Business partners schema: vendors, customers, and their profiles.
 * Centralized partner management with AP/AR-specific extensions.
 */
import {
	decimal,
	index,
...
// --- BUSINESS PARTNERS (unified vendors + customers) ---
...
// --- VENDOR PROFILES (extends businessPartners for AP) ---
...
// --- CUSTOMER PROFILES (extends businessPartners for AR) ---
