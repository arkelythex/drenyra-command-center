...
export const platformMcpAuditEvents = pgTable("platform_mcp_audit_events", {
    ...
    scopeIdx: index("pmcp_audit_scope_idx").on(table.companyId, table.companyRuc, table.period),
    toolOutcomeIdx: index("pmcp_audit_tool_outcome_idx").on(table.toolName, table.outcome),
}));
