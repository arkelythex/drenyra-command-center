...
import { pgTable, uuid, varchar, decimal, timestamp, date, boolean, text } from 'drizzle-orm/pg-core';
...
export const fixedAssets = pgTable('fixed_assets', {
  ...
  purchasePrice: decimal('purchase_price', { precision: 19, scale: 2 }).notNull(),
