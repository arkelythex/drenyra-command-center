...
export const pcgeAccounts = pgTable("pcge_accounts", {
    ...
    companyCodeIdx: index("pcge_company_code_idx").on(table.companyId, table.code),
...
export const accountingPeriods = pgTable("accounting_periods", {
    ...
    companyPeriodIdx: index("accounting_periods_company_period_idx").on(table.companyId, table.year, table.month),
...
export const exchangeRates = pgTable("exchange_rates", {
    ...
    companyCurrencyIdx: index("exchange_rates_company_currency_idx").on(table.companyId, table.currencyFrom, table.currencyTo),
    dateIdx: index("exchange_rates_date_idx").on(table.date),
}));
export const cpeLog = pgTable("cpe_log", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id")
        .references(() => companies.id)
        .notNull(),
    ...
    companyInvoiceStatusIdx: index("cpe_log_company_invoice_status_idx").on(table.companyId, table.invoiceId, table.sunatStatus),
    statusIdx: index("cpe_log_status_idx").on(table.sunatStatus),
}));
export const detractions = pgTable("detractions", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id")
        .references(() => companies.id)
        .notNull(),
    ...
    companyStatusIdx: index("detractions_company_status_idx").on(table.companyId, table.status),
...
export const journalEntries = pgTable("journal_entries", {
    ...
    companyPeriodIdx: index("journal_entries_company_period_idx").on(table.companyId, table.periodKey),
