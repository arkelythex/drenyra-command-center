...
export const evidenceNodes = pgTable("fiscal_evidence_nodes", {
    ...
    scopeNodeIdx: index("fen_scope_node_idx").on(table.nodeId, table.companyId, table.companyRuc, table.period),
}));
export const fiscalTruthEvents = pgTable("fiscal_truth_events", {
    ...
    aggregateScopeIdx: index("fte_aggregate_scope_idx").on(table.aggregateId, table.companyId, table.companyRuc, table.period),
}));
export const evidenceEdges = pgTable("fiscal_evidence_edges", {
    ...
    fromScopeIdx: index("fee_from_scope_idx").on(table.fromNodeId, table.companyId, table.companyRuc, table.period),
    toScopeIdx: index("fee_to_scope_idx").on(table.toNodeId, table.companyId, table.companyRuc, table.period),
}));
export const fiscalReplayCheckpoints = pgTable("fiscal_replay_checkpoints", {
    ...
    aggregateScopeIdx: index("frc_aggregate_scope_idx").on(table.aggregateId, table.companyId, table.companyRuc, table.period),
}));
export const fiscalTruthEventsRelations = relations(fiscalTruthEvents, ({ one }) => ({
