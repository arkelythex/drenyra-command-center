...
import { currencyEnum, invoiceStatusEnum, sunatStatusEnum, taxTypeEnum, } from "./enums";
...
export const invoices = pgTable("invoices", {
    ...
    companySeriesIdx: index("invoice_company_series_idx").on(t.companyId, t.series, t.correlative),
