...
export const aiAgents = pgTable("ai_agents", {
    ...
    scopeIdx: index("ai_agents_scope_idx").on(table.tenantId, table.organizationId, table.companyId, table.ruc),
...
export const aiTraceEvidence = pgTable("ai_trace_evidence", {
    id: serial("id").primaryKey(),
    ...
    tenantScopeIdx: index("ai_trace_evidence_tenant_scope_idx").on(table.tenantScope),
