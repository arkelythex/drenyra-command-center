...
export const fiscalMemories = pgTable("fiscal_memories", {
...
export const fiscalMemoryRevisions = pgTable("fiscal_memory_revisions", {
    id: text("id").primaryKey(),
    ...
    memoryRevisionIdx: uniqueIndex("fiscal_memory_revisions_memory_revision_idx").on(table.memoryId, table.revisionNumber),
