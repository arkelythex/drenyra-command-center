...
function nodeScopeFilter(scope) {
    ...
    if (scope.organizationId !== null) {
        conditions.push(eq(evidenceNodes.organizationId, String(scope.organizationId)));
    }
    else {
...
function edgeScopeFilter(scope) {
    ...
    if (scope.organizationId !== null) {
        conditions.push(eq(evidenceEdges.organizationId, String(scope.organizationId)));
    }
    else {
