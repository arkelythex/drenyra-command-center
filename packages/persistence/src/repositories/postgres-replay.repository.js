...
import { fiscalReplayCheckpoints, fiscalTruthEvents, } from "../schema/fiscal-truth.schema";
...
export class PostgresReplayRepository {
    ...
    async saveReplayResult(aggregateId, result, scope) {
        await this.client.insert(fiscalReplayCheckpoints).values({
            ...
            organizationId: scope.organizationId === null ? null : String(scope.organizationId),
            period: scope.period,
