...
export declare function logRequest(method: string, path: string, statusCode: number, duration: number, correlationId?: string): void;
export declare function logOperation<T>(operation: string, context: Record<string, unknown>, fn: () => Promise<T>): Promise<T>;
