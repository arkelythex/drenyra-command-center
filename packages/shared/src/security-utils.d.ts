export declare function sanitizeSqlInput(
	input: string,
	maxLength?: number,
): string;
...
export declare function sanitizeDateRange(
...
export declare const SECURITY_CONSTANTS: {
	...
	readonly ALLOWED_SORT_FIELDS: readonly [
		"createdAt",
		"updatedAt",
		"totalAmount",
		"issueDate",
...
export declare function sanitizePagination(
	limit: number | string,
