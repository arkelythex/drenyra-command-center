...
export declare const ADMIN_ONLY_ACTIONS: readonly [
	"company:delete",
	"users:create_staff",
	"audit:read",
	"accounting:close",
];
export declare const PROTECTED_RESOURCES: readonly [
	"ledger:delete",
	"ledger:override",
	"journal:delete",
	"users:delete",
...
export declare function shouldLogAccess(
	action: string,
	result: AccessLog["result"],
): boolean;
export declare function createAccessLogEntry(
	userId: string,
	action: string,
	resource: string,
	result: AccessLog["result"],
...
export declare function createFailedLoginEntry(
	email: string,
	ipAddress: string,
