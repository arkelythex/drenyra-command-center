...
export class ConcurrentModificationError extends DomainError {
    constructor(resource, message = "This record was modified by another user. Please refresh and try again.") {
...
export class IdempotencyConflictError extends DomainError {
    constructor(key) {
        super(`Request with idempotency key "${key}" is already being processed`, "IDEMPOTENCY_CONFLICT", 409);
