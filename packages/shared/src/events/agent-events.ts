/**
 * Canonical typed agent events for ARKELYTHEX.
 *
 * Discriminated union of 11 event variants covering streaming protocol events
 * (tool calls, thinking, approvals, usage). Zero runtime dependencies.
 *
 * @module agent-events
 */
...
/** Union of all event type literals — derived from AgentEvent. */
