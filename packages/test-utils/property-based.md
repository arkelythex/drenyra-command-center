...
])('IGV debe ser 18% de la base imponible', (baseCents) => {
...
test.prop([
  fc.constantFrom(['pending', 'deposited', 'used', 'released']),
])('solo transiciones válidas de detracción', (fromState) => {
...
```typescript
test.prop([
  fc.integer({ min: 10_000_000_000, max: 20_000_000_000 }),
])('RUC checksum debe ser válido', (rucNumber) => {
