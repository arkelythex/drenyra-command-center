...
> = {
	...
	"010": {
		code: "010",
		description: "Residuos, subproductos, desechos y formas primarias",
		percentage: 15,
	},
	"011": {
		code: "011",
		description: "Bienes gravados con IGV por renuncia a exoneración",
		percentage: 10,
	},
	"012": {
		code: "012",
	...
	"017": {
		code: "017",
		description: "Harina, polvo de pescado y crustáceos",
		percentage: 4,
	},
	"019": {
		code: "019",
	...
	"032": {
		code: "032",
		description: "Páprika y otros frutos capsicum",
		percentage: 10,
	},
	"034": {
		code: "034",
	...
	"036": {
		code: "036",
		description: "Oro y minerales metálicos exonerados del IGV",
		percentage: 1.5,
	},
	"037": {
		code: "037",
