export const SUNAT_2026_SEED = [
    ...
    },
    {
        ...
        content: "La SUNAT verificará la consistencia entre los registros del SIRE (RVIE y RCE) y el Programa de Libros Electrónicos (PLE). Una diferencia de cero comprobantes entre RVIE y ventas PLE, o entre RCE y compras PLE, indica consistencia perfecta. Cualquier brecha (gap) en el número de registros activa alerta de inconsistencia CPE y requiere conciliación previa a la presentación del período. Código de alerta: SUNAT_AI_CPE_INCONSISTENCY.",
        category: "sire",
        section: "Artículo 4",
    ...
    },
    {
        ...
        content: "La RS NATI 000005-2026/SUNAT establece un período de adaptación de marzo a mayo 2026 (3 meses). Durante este período, la SUNAT ejercerá facultad discrecional respecto a infracciones relacionadas con el SIRE para PRICOS en proceso de implementación. Después del 1 de junio de 2026, el SIRE es obligatorio sin excepciones. La propuesta de RVIE/RCE generada por SUNAT puede ser: aceptada (sin cambios), complementada (agrega comprobantes no detectados) o sustituida (reemplaza completamente con el registro propio).",
        category: "sire",
    ...
    },
    {
        ...
        content: "El Régimen de Retenciones del IGV obliga a los Agentes de Retención designados por SUNAT a retener el 3% del importe total de las operaciones gravadas con IGV superiores a S/ 700 (incluido el impuesto). El importe retenido se entrega al fisco mediante formulario PDT 626. El proveedor puede usar el monto retenido como crédito contra su IGV por pagar. Los Agentes de Retención están designados en una lista publicada por SUNAT en su portal web. La no retención genera multa al agente.",
        category: "retencion",
