...
export declare const anomalyAlertRepository: {
    ...
    findByOrganization(organizationId: number, options?: {
        limit?: number;
        status?: string;
    }): Promise<{
        id: string;
    ...
    getRecentBySeverity(organizationId: number, severity: AlertSeverity, days?: number): Promise<{
        status: "pending" | "confirmed" | "false_positive" | "resolved";
        severity: "low" | "medium" | "high" | "critical";
        threshold: string;
    }[]>;
    markAsFalsePositive(id: string, reason: string, resolvedBy: string): Promise<void>;
    markAsConfirmed(id: string, resolvedBy: string): Promise<void>;
    markAsResolved(id: string, resolvedBy: string): Promise<void>;
    getFalsePositiveRate(organizationId: number, severity: AlertSeverity, days?: number): Promise<FalsePositiveStats>;
};
