...
export declare function enqueueDocument(data: Omit<DocumentJobData, "timestamp">): Promise<string | null>;
export declare function enqueueBatch(documents: Omit<DocumentJobData, "timestamp">[]): Promise<{
    queued: number;
    syncRequired: number;
}>;
