	...
	return {
		...
		descargarArchivoSire: mock(async (_ruc: string, _cod: string) => ({
			...
			data: {
				...
				archivo: Buffer.from(
					"202604|001|01/04/2026|01|F001|00000001|6|20123456789|TEST SAC|1000.00|180.00|1180.00|PEN||ACTIVO",
				),
			},
		})),
	};
...
describe("SunatSireService", () => {
	describe("parseRecords", () => {
		...
		it("returns empty array for empty content", () => {
			...
			expect(
				service.parseRecords(Buffer.from("   \n\n  "), "VENTAS"),
			).toHaveLength(0);
		});
	...
	describe("findDiscrepancies", () => {
		const localRecords: SireRecord[] = [
			{
				...
				numero: "00000001",
				tipoDocIdentidad: "6",
				numeroDocIdentidad: "20123456789",
				razonSocial: "LOCAL SAC",
			...
			},
			{
				...
				numero: "00000099",
				tipoDocIdentidad: "6",
				numeroDocIdentidad: "20546296564",
				razonSocial: "LOCAL ONLY SAC",
				baseImponible: 50000,
				igv: 9000,
				total: 59000,
				moneda: "PEN",
		...
		const sireRecords: SireRecord[] = [
			{ ...localRecords[0] }, // Matching
			{
				...
				numero: "00000200",
				tipoDocIdentidad: "6",
				numeroDocIdentidad: "20601234573",
				razonSocial: "SUNAT ONLY SAC",
