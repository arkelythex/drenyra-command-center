...
declare class UBLInvoiceParserAdapter implements IUBLInvoiceParser {
    ...
    parseInvoice(xmlContent: string): import("../xml/ubl-parser.types").ParsedInvoice;
}
...
declare class DocumentSyncProcessorAdapter implements IDocumentSyncProcessor {
    processDocumentSync(payload: Parameters<typeof processDocumentSync>[0]): Promise<import("../queues/document-processor.queue").DocumentJobResult>;
}
