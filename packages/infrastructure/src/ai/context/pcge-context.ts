/**
 * PCGE Context - Plan Contable General Empresarial
 *
 * Full context for Gemini Context Caching.
 * This file contains the complete PCGE structure and SUNAT regulations
 * for accurate accounting classification in Peru.
 *
 * @description This context is designed to be cached using Gemini's
 * Context Caching feature to reduce latency and costs.
 *
 * @since 2026 Gemini Brain Standard
 * @example
 * ```ts
 * console.log(PCGE_FULL_CONTEXT);
 * ```
 */
...
// ============================================
// CONTEXT FOR EXPENSE CLASSIFICATION
// ============================================

/**
 * EXPENSE_CLASSIFICATION_CONTEXT const.
 *
 * @example
 * ```ts
 * console.log(EXPENSE_CLASSIFICATION_CONTEXT);
 * ```
 */
...
/**
 * FUNCTION_CALLING_INSTRUCTIONS const.
 *
 * @example
 * ```ts
 * console.log(FUNCTION_CALLING_INSTRUCTIONS);
 * ```
 */
...
/**
 * GEMINI_SYSTEM_INSTRUCTION const.
 *
 * @example
 * ```ts
 * console.log(GEMINI_SYSTEM_INSTRUCTION);
 * ```
 */
