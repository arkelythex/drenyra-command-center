...
export const geminiToolDefinitions = [
    ...
    },
    {
        ...
        description: "Validar un RUC con SUNAT y obtener información del contribuyente",
        parameters: ConsultarRucSchema,
    },
    {
        name: "calcular_detraccion",
        description: "Calcular el monto de detracción según el tipo de servicio y umbral de S/ 700",
    ...
    },
    {
        ...
        description: "Obtener el tipo de cambio oficial de la SBS para una fecha específica",
        parameters: ObtenerTipoCambioSchema,
    },
    {
        name: "registrar_gasto_voz",
        description: "Registrar un gasto a partir de un comando de voz. Crea el asiento contable correspondiente.",
