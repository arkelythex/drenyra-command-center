...
>;
export declare function calcularDetraccion(
...
>;
export declare function verificarComprobante(
	input: VerificarComprobanteInput,
): Promise<{
	success: true;
	es_valido: boolean;
...
export declare function obtenerTipoCambio(
	input: ObtenerTipoCambioInput,
): Promise<{
	success: true;
	fecha: string;
	moneda: "USD" | "EUR";
...
export declare function registrarGastoVoz(
	input: RegistrarGastoVozInput,
): Promise<{
	success: true;
	asiento_id: string;
	cuenta_usada: string;
...
export declare function executeGeminiTool(
	toolName: string,
	args: unknown,
): Promise<
	| {
