export type LegalDocumentType = "CODIGO_TRIBUTARIO" | "LEY_IMPUESTO_RENTA" | "LEY_IGV" | "RTF" | "DECRETO_SUPREMO" | "DECRETO_LEGISLATIVO" | "RESOLUCION_SUNAT" | "INFORME_SUNAT" | "PCGE" | "NIC" | "NIIF";
...
export type EmbeddingModel = "text-embedding-3-large" | "text-embedding-3-small" | "bge-m3" | "multilingual-e5-large" | "nomic-embed-text";
...
export type RerankerModel = "cross-encoder/ms-marco-MiniLM-L-12-v2" | "BAAI/bge-reranker-v2-m3" | "cohere-rerank-v3";
...
export declare class RAGError extends Error {
    ...
    constructor(message: string, code: RAGErrorCode, details?: Record<string, unknown> | undefined);
}
export type RAGErrorCode = "EMBEDDING_FAILED" | "SEARCH_FAILED" | "RERANK_FAILED" | "GENERATION_FAILED" | "DOCUMENT_NOT_FOUND" | "INVALID_QUERY" | "CONTEXT_TOO_LARGE" | "RATE_LIMITED";
