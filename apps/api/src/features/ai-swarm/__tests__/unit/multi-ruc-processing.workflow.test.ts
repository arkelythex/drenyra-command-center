...
describe('MultiRucProcessingWorkflow', () => {
  ...
  it('processes companies in parallel and aggregates execution summary', async () => {
    vi.spyOn(CompleteInvoiceProcessingWorkflow.prototype, 'execute').mockResolvedValue({
      totalProcessed: 2,
      totalSuccess: 2,
      totalFailed: 0,
      results: [],
      ...
      companies: [
        {
          ...
          companyName: 'A',
          documents: [
            { id: 'A1', imageUrl: 'img://a1', filename: 'a1.pdf', mimeType: 'application/pdf' },
            { id: 'A2', imageUrl: 'img://a2', filename: 'a2.pdf', mimeType: 'application/pdf' },
          ],
        },
        {
          ruc: '20553510661',
          companyName: 'B',
          documents: [
            { id: 'B1', imageUrl: 'img://b1', filename: 'b1.pdf', mimeType: 'application/pdf' },
            { id: 'B2', imageUrl: 'img://b2', filename: 'b2.pdf', mimeType: 'application/pdf' },
          ],
        },
      ],
      priority: 'high',
