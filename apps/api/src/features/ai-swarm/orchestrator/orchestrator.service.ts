...
import { hasOpenRouterKey, openrouter, getModelForAgent } from '../config/openrouter.config';
...
export class OrchestratorService {
  ...
  async reviewExecutionPlan(
    ...
    if (!hasOpenRouterKey()) {
      return { approved: true, feedback: 'Skipped: OPENROUTER_API_KEY not configured.' };
    }
