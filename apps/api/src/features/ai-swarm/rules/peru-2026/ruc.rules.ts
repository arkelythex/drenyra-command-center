...
export const RUC_RULES_2026: PeruRule2026[] = [
	...
	},
	{
		...
		severity: "high",
		summary:
			"Comprobantes para deducción tributaria exigen proveedor con RUC activo.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "high",
		summary:
			"Estado NO HABIDO debe bloquear aprobación automática y escalar a revisión manual.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "high",
		summary:
			"Estado NO HALLADO debe marcarse como alerta crítica para validación documental adicional.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "medium",
		summary:
			"Cambios recientes de estado RUC en ventana de 30 días incrementan score de riesgo.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "high",
		summary:
			"RUC emisor en CPE debe coincidir con emisor registrado en payload y PDF.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "medium",
		summary:
			"Diferencias entre RUC emisor y RUC receptor en notas referenciadas deben explicitar motivo.",
		effectiveFrom: "2026-01-01",
	...
	},
	{
		...
		severity: "medium",
		summary:
			"Contribuyentes con estado no válido no pueden pasar a flujo de consenso sin intervención humana.",
		effectiveFrom: "2026-01-01",
