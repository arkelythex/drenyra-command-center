...
export const SOURCES_2026 = {
  sireRs3922025: {
    title: 'SUNAT - Resolución 000392-2025/SUNAT (SIRE desde junio 2026 para PRICOS >= 2,300 UIT)',
    url: 'https://www.sunat.gob.pe/legislacion/superin/2025/392-2025.pdf',
  },
  sireRsnati0000052026: {
    title: 'SUNAT - RSNATI 000005-2026 (facultad discrecional y adaptación SIRE 2026)',
  ...
  cpeNotaDebito: {
    title: 'SUNAT CPE - Nota de Débito Electrónica (validaciones de receptor y referencia)',
  ...
  projectBoletosAereos2026: {
    title: 'SUNAT - Proyecto RS 000002-2026 (declaración informativa boletos aéreos)',
