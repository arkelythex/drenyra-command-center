...
const logger = createLogger({ module: 'ai-swarm/complete-invoice-processing-workflow' });
...
export class CompleteInvoiceProcessingWorkflow {
   ...
   */
  async execute(input: CompleteProcessingInput): Promise<CompleteProcessingOutput> {
  ...
  private async processDocument(
    ...
    return {
      ...
      evidence: {
        ...
        error: 'error' in evidenceResult ? evidenceResult.error?.message : undefined,
