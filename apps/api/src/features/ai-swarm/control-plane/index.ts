...
const approvalScopeSchema = t.Object({
...
const approvalRequestBodySchema = t.Object({
...
const traceRetrievalBodySchema = t.Object({
	traceId: t.String({ minLength: 1 }),
	tenantId: t.String({ minLength: 1 }),
	organizationId: t.String({ minLength: 1 }),
	companyId: t.String({ minLength: 1 }),
...
const syncTraceApprovalLineage = (
	traceEvidenceStore: TraceEvidenceStore,
	approval: ApprovalRecord,
): void => {
...
const appendApprovalAuditEvent = (
	traceEvidenceStore: TraceEvidenceStore,
	approval: ApprovalRecord,
	eventType:
		| "approval.requested"
