...
export const CreateAiToolPermissionSchema = t.Object({
  ...
  companyId: t.Optional(t.String({ description: 'ID de la empresa (opcional)' })),
  organizationId: t.Optional(t.String({ description: 'ID de la organización (opcional)' })),
});
...
export const UpdateAiToolPermissionSchema = t.Object({
  toolName: t.Optional(t.String({ description: 'Nombre de la herramienta de IA' })),
  effect: t.Optional(
    t.Union([
      t.Literal('ALLOW'),
      t.Literal('DENY'),
