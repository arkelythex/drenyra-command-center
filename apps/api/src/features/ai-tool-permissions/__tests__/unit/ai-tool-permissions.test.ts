...
describe("AiToolPermissionService", () => {
	...
	describe("getById", () => {
		it("should return a permission when found", async () => {
			mockDb.query.aiToolPermissions.findFirst.mockResolvedValue(
				mockPermission,
			);

			const result = await AiToolPermissionService.getById(
	...
	describe("update", () => {
		...
		it("should throw when permission to update is not found", async () => {
			...
			await expect(
				AiToolPermissionService.update("00000000-0000-0000-0000-000000000099", {
					effect: "DENY",
				}),
	...
	describe("delete", () => {
		it("should hard delete a permission successfully", async () => {
			...
			const result = await AiToolPermissionService.delete(
				"00000000-0000-0000-0000-000000000001",
			);
