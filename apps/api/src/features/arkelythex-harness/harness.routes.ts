...
/**
 * ARKELYTHEX Drenyra sovereign agent harness — HTTP entry for nested delegation tree.
 */
export const arkelythexHarnessRoutes = new Elysia({ prefix: "/harness" })
	.get(
		"/agents",
		() => {
			return ok({
		...
		{ detail: { tags: ["ARKELYTHEX Harness"] } },
	)
	.post(
		"/execute",
