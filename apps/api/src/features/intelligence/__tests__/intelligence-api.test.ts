	...
	it("returns empty anomalies for stable cashflow", async () => {
		const res = await buildApp().handle(
			new Request("http://localhost/api/intelligence/cashflow/analyze", {
				...
				body: JSON.stringify({
					transactions: [
						{ id: "1", date: "2026-06-01", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "2", date: "2026-06-02", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "3", date: "2026-06-03", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "4", date: "2026-06-04", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "5", date: "2026-06-05", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "6", date: "2026-06-06", amount: 1000, type: "INCOME", category: "sales" },
						{ id: "7", date: "2026-06-07", amount: 1000, type: "INCOME", category: "sales" },
					],
				}),
			}),
		);
	...
	it("analyzes suppliers and returns risk anomalies", async () => {
		const res = await buildApp().handle(
			new Request("http://localhost/api/intelligence/suppliers/analyze", {
				...
				body: JSON.stringify({
					suppliers: [
						{ id: "sup-1", name: "Proveedor A", ruc: "20123456789", createdAt: "2024-01-01" },
						{ id: "sup-2", name: "Proveedor B", ruc: "20198765432", createdAt: "2024-06-01" },
					],
					transactions: [
						{
							id: "trx-1", supplierId: "sup-1", supplierName: "Proveedor A",
							supplierRuc: "20123456789", documentType: "01", serie: "F001",
							numero: "1", amount: 50000, currency: "PEN",
							issueDate: "2026-06-01", dueDate: "2026-06-15",
							paymentDate: null, paid: false,
						},
					],
				}),
			}),
