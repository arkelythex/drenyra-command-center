...
const SUNAT_2026_DEADLINES: Record<string, Record<number, string>> = {
  '2026-01': { 0: '2026-02-13', 1: '2026-02-14', 2: '2026-02-17', 3: '2026-02-18', 4: '2026-02-19', 5: '2026-02-20', 6: '2026-02-21', 7: '2026-02-24', 8: '2026-02-25', 9: '2026-02-26' },
  '2026-02': { 0: '2026-03-13', 1: '2026-03-14', 2: '2026-03-17', 3: '2026-03-18', 4: '2026-03-19', 5: '2026-03-20', 6: '2026-03-21', 7: '2026-03-24', 8: '2026-03-25', 9: '2026-03-26' },
};
...
export class FiscalIndicatorsService {
   ...
   */
  static async getTaxCalendar(companyId: string, month?: number, year?: number) {
    const now = new Date();
    ...
    const obligations = [
      {
        ...
        period,
        dueDate: SUNAT_2026_DEADLINES[period]?.[0] ?? `${targetYear}-${String(targetMonth + 1).padStart(2, '0')}-15`,
