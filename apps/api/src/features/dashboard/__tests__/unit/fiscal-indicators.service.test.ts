...
describe('FiscalIndicatorsService', () => {
  ...
  describe('getTaxCalendar', () => {
    it('returns SUNAT 2026 tax calendar structure', () => {
      ...
      const obligations = [
        { code: 'PDT621', name: expect.any(String), period, dueDate: expect.any(String), status: expect.any(String) },
        { code: 'SIRE', name: expect.any(String), period, dueDate: expect.any(String), status: expect.any(String) },
        { code: 'PLE', name: expect.any(String), period, dueDate: expect.any(String), status: expect.any(String) },
        { code: 'SPOT', name: expect.any(String), period, dueDate: expect.any(String), status: expect.any(String) },
      ];
