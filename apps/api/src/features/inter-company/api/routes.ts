...
const createHandler = new CreateInterCompanyTransactionHandler(
	interCompanyTransactionRepository,
);
const generateSpotPdfHandler = new GenerateSpotPdfHandler(
	interCompanyTransactionRepository,
);
const getTransactionsHandler = new GetTransactionsHandler(
	interCompanyTransactionRepository,
);
const getDetractionAuditHandler = new GetDetractionAuditHandler(
	interCompanyTransactionRepository,
);
...
export const interCompanyRoutes = new Elysia({ prefix: "/api/inter-company" })
	...
	.post(
		...
		{
			body: interCompanyCreateBodySchema,
			detail: interCompanyRouteDetails.create,
		},
	)
	.get(
		"/audit",
		...
		{
			query: interCompanyAuditQuerySchema,
			detail: interCompanyRouteDetails.audit,
		},
	)
	.get(
