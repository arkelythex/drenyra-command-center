...
): { valid: true; data: OrganizationSettings } | { valid: false; error: string } {
...
export async function updateClientSettings(
	...
	try {
		...
		if (!client) {
			return { success: false, error: "Client not found", code: "CLIENT_NOT_FOUND" };
		}

		// Tenant scope check
		const clientSettings = client.settings as Record<string, unknown> | undefined;
