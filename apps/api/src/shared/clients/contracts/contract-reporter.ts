...
export class ContractReporter {
  ...
  constructor(private readonly reportPath: string | undefined, private readonly baseUrl: string, private readonly requireContracts: boolean) {
    this.report = {
  ...
  async flush(): Promise<void> {
    ...
    await writeFile(absolutePath, `${JSON.stringify(this.report, null, 2)}\n`, "utf-8");
  }
}
