...
export const SHADOWS = {
	...
	blue: "0 0 0 1px rgba(var(--premium-info-rgb), 0.3), 0 0 24px rgba(var(--premium-action-blue-rgb), 0.22)",
	emerald:
		"0 0 0 1px rgba(45, 255, 122, 0.24), 0 0 24px rgba(45, 255, 122, 0.16)",
	amber:
		"0 0 0 1px rgba(255, 200, 87, 0.24), 0 0 24px rgba(255, 200, 87, 0.14)",
	red: "0 0 0 1px rgba(255, 107, 107, 0.24), 0 0 24px rgba(255, 107, 107, 0.14)",
	glow: "0 0 0 1px rgba(var(--premium-info-rgb), 0.3), 0 0 24px rgba(var(--premium-action-blue-rgb), 0.22)",
	intense:
