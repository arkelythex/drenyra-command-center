...
export const GRADIENTS = {
	...
	ambientVertical:
		"bg-gradient-to-b from-[var(--premium-action-cyan)] via-transparent to-[var(--premium-action-blue)]",
	iconBlue:
		"bg-gradient-to-br from-[var(--premium-action-cyan)] to-[var(--premium-action-blue)]",
	iconEmerald:
		"bg-gradient-to-br from-[var(--premium-success)] to-[rgba(var(--premium-success-rgb),0.25)]",
	iconAmber: "bg-gradient-to-br from-amber-400/24 to-amber-500/10",
	iconRed:
		"bg-gradient-to-br from-[var(--color-danger)]/24 to-[var(--color-danger)]/10",
	hoverBlue:
		"bg-gradient-to-r from-[var(--premium-action-cyan)] to-[var(--premium-action-blue)]",
	hoverEmerald:
		"bg-gradient-to-r from-[var(--premium-success)] to-[rgba(var(--premium-success-rgb),0.25)]",
	hoverSteel:
		"bg-gradient-to-r from-[var(--premium-action-cyan)] to-[var(--premium-action-blue)]",
	premiumGlass:
	...
	hoverOverlay:
		"bg-gradient-to-r from-transparent via-[rgba(var(--premium-info-rgb),0.20)] to-transparent",
	hoverOverlayTr:
		"bg-gradient-to-tr from-[var(--premium-action-cyan)] to-transparent",
} as const;
...
/** Flat editorial surfaces — canonical Fiscal Editorial v3 (no decorative blur). */
export const SURFACE_EFFECTS = {
	card: "rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--surface-1)] shadow-[var(--shadow-1)]",
	cardPremium:
		"rounded-[var(--radius-lg)] border border-white/12 bg-[var(--surface-2)] shadow-[var(--shadow-2)]",
	panel:
		"rounded-[var(--radius-lg)] border border-white/8 bg-[var(--surface-1)] shadow-[var(--shadow-1)]",
	sidebar:
		"bg-[var(--surface-1)] border-r border-[var(--border-subtle)] shadow-[0_1px_0_rgba(255,255,255,0.03)]",
	active:
		"bg-[rgba(var(--premium-info-rgb),0.16)] border-[rgba(var(--premium-info-rgb),0.35)] text-[var(--color-text-primary)]",
} as const;

/**
 * @deprecated Use SURFACE_EFFECTS — retained for token-helpers migration only.
 * New feature code MUST NOT reference GLASS_EFFECTS (includes backdrop-blur).
 */
export const GLASS_EFFECTS = {
	card: "bg-[rgba(24,24,24,0.78)] border border-white/10 backdrop-blur-[20px] shadow-[var(--shadow-1)]",
	cardPremium:
		"bg-[rgba(24,24,24,0.86)] border border-white/12 backdrop-blur-[22px] shadow-[var(--shadow-2)]",
	panel:
		"bg-[rgba(24,24,24,0.8)] border border-white/8 backdrop-blur-[20px] shadow-[var(--shadow-1)]",
	sidebar:
