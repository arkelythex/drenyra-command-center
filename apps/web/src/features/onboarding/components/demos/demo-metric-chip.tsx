...
export const DemoMetricChip = ({ label, value, highlight = false }: OutcomeMetric) => (
  <div
    className={cn(
      'flex flex-col gap-0.5 rounded-xl border p-3',
      highlight ? 'border-foreground/20 bg-foreground/10' : 'border-border/10 bg-foreground/[0.03]',
    )}
  >
