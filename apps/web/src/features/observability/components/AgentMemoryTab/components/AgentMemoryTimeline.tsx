...
export function AgentMemoryTimelineEntry({
	entry,
	index,
}: AgentMemoryTimelineEntryProps) {
	const dotColor =
		DOT_COLORS[entry.workflowState] ?? "bg-[var(--text-tertiary)]";
