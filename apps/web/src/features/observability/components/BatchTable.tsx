...
const STATUS_BADGE_COLORS: Record<BatchStatus, string> = {
  pending: "bg-[var(--color-info)]/10 text-[var(--color-info)] border-[var(--color-info)]/25",
  running: "bg-[var(--color-info)]/10 text-[var(--color-info)] border-[var(--color-info)]/25",
  ...
  partial: "bg-[var(--color-warning)]/10 text-[var(--color-warning)] border-[var(--color-warning)]/25",
};
              ...
              <td className="px-4 py-3 text-right">
                {(batch.status === "running" || batch.status === "pending") && onCancelBatch && (
                  <Button
                    ...
                    onClick={(e) => { e.stopPropagation(); onCancelBatch(batch.id); }}
                  >
