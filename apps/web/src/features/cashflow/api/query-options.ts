...
export function cashflowProjectionQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const result = await cashflowApi.getProjection({ companyId, days, currency: currency as 'PEN' | 'USD' | 'EUR' })
...
export function cashflowActualQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const result = await cashflowApi.getActual({ companyId, startDate, endDate, currency: currency as 'PEN' | 'USD' | 'EUR' })
      if (!result.ok) throw new Error(result.error)
      return result.data
    },
  })
...
export function cashflowForecastQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const result = await cashflowApi.getForecast({ companyId, months, currency: currency as 'PEN' | 'USD' | 'EUR' })
      if (!result.ok) throw new Error(result.error)
      return result.data
    },
  })
...
export function cashflowVarianceQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const result = await cashflowApi.getVariance({ companyId, startDate, endDate, currency: currency as 'PEN' | 'USD' | 'EUR' })
      if (!result.ok) throw new Error(result.error)
      return result.data
    },
  })
