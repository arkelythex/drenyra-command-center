...
interface CashflowBoardColumnData {
	id: string;
	title: string;
	taskIds: string[];
}
...
interface CashflowBoardColumnProps {
	...
	column: CashflowBoardColumnData;
	...
	return (
		<div className="flex h-full max-h-full w-[300px] shrink-0 flex-col md:w-[340px] lg:w-80 xl:w-[360px] 2xl:w-80">
			...
			>
				<div
					className={cn(
						"sticky top-0 border-b border-border/50 bg-muted/20 p-6",
						backdropBlurClassName,
					)}
				...
				>
					<div className="mb-4 flex items-start justify-between">
						<div className="flex items-center gap-2">
							...
							<Text
								variant="label"
								className="text-label tracking-[0.2em] opacity-70"
							>
								{column.title}
							</Text>
						</div>
