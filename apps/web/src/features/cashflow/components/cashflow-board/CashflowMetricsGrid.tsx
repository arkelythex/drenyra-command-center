		...
		<div className="mb-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
			...
			>
				...
				<p className="mt-2 text-xs text-muted-foreground">
					Ingresos {formatMoney(actualInflows)} · Egresos{" "}
					{formatMoney(actualOutflows)}
				</p>
			</Card>
			<Card
				variant="default"
			...
			>
				...
				<p className="mt-2 text-xs text-muted-foreground">
					Por cobrar {formatMoney(incomePending)} · Por pagar{" "}
					{formatMoney(expensePending)}
				</p>
			</Card>
			<Card
				variant="default"
			...
			>
				...
				<p className="mt-2 text-xs text-muted-foreground">
					Neto {formatPercentage(netPercentage)}
				</p>
			</Card>
			<Card
				variant="default"
			...
			>
				...
				<p className="mt-2 text-xs text-muted-foreground">
					Forecast basado en {basedOnMonths} meses
				</p>
			</Card>
		</div>
	);
