			...
			>
				...
				<div className="relative">
					{user.image ? (
						...
						<div
							className={`h-8 w-8 rounded-full ${avatarColor} flex items-center justify-center ring-2 ring-border`}
						>
				...
				<DropdownMenuLabel className="pb-3">
					<div className="flex items-start gap-3">
						{user.image ? (
							...
							<div
								className={`h-10 w-10 rounded-full ${avatarColor} flex items-center justify-center ring-2 ring-primary/20`}
							>
						...
						<div className="flex-1 min-w-0">
							...
							<div className="flex items-center gap-2 mt-1.5">
								...
								{!user.emailVerified && (
									<Badge
										variant="outline"
										className="text-xs px-2 py-0 h-5 border-amber-500/50 text-amber-600"
									>
										No verificado
									</Badge>
								)}
