...
export const SignupForm = () => {
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      ...
      toast.success('¡Cuenta creada exitosamente!', {
        description: message || 'Te estamos redirigiendo al inicio de sesión...',
      });
      ...
      captureError(error instanceof Error ? error : new Error('Signup failed'), {
  ...
  return (
    <AuthLayout title="Registro" subtitle="Cree su cuenta para acceder a la plataforma.">
      <MotionDiv
