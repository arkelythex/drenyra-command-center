  ...
  return (
    <MotionDiv variants={entranceVariants} className="text-center mb-12">
      <div className="inline-flex items-center gap-4 mb-6">
        ...
        <Text variant="hero" className="text-4xl font-bold tracking-tight text-foreground">
          ARK<span className="text-foreground/75">O</span>NYX
        </Text>
      </div>
      <Text variant="label" className="mt-3 block text-sm font-mono uppercase tracking-wider text-muted-foreground">
