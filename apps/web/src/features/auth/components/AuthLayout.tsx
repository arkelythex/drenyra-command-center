        ...
        <section className="w-full max-w-[440px] space-y-8 sm:max-w-[460px]">
          <div className="space-y-5 text-center">
            ...
            <div className="space-y-3">
              <p className="text-3xs font-black uppercase tracking-[0.42em] text-white/85">Acceso corporativo</p>
              <h3 className="text-4xl font-black uppercase leading-[0.9] tracking-[-0.08em] text-white sm:text-5xl">{title}</h3>
              <p className="mx-auto max-w-md text-sm font-bold leading-6 text-white/80">{subtitle}</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className={cn(tokensToClasses.borderRadius('card'), "relative overflow-hidden border border-white/15 bg-[linear-gradient(145deg,rgba(255,255,255,0.045),rgba(9,16,22,0.82))] p-7 shadow-[0_30px_90px_rgba(0,0,0,0.55)] backdrop-blur-2xl sm:p-10")}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-[color:rgb(from_var(--color-info)_r_g_b_/_0.12)] px-4 py-3">
              ...
              <span className="text-3xs font-black uppercase tracking-[0.18em] text-white/80">Sesión cifrada</span>
            </div>
            <div className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-[color:rgb(from_var(--color-info)_r_g_b_/_0.12)] px-4 py-3">
              <CheckCircle2 size={13} className="text-white/85" />
              <span className="text-3xs font-black uppercase tracking-[0.18em] text-white/80">Tenant seguro</span>
            </div>
          </div>
        </section>
      </main>
