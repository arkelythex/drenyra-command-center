...
export function EmailVerificationBanner() {
	...
	const handleResendEmail = async () => {
		...
		try {
			...
			toast.error("Error al enviar email", {
				description:
					"No pudimos enviar el email de verificación. Intenta nuevamente.",
			});
		} finally {
	...
	return (
		<div className="sticky top-0 z-50 bg-gradient-to-r from-yellow-500/10 to-amber-500/10 border-b border-yellow-500/20 ">
