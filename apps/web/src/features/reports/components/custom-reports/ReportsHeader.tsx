...
export const ReportsHeader = ({
	...
	return (
		<header className="sticky top-0 z-[40] flex shrink-0 flex-col items-center justify-between gap-6 border-b border-[var(--border-subtle)] bg-[var(--surface-1)] px-6 py-6 shadow-sm md:flex-row">
