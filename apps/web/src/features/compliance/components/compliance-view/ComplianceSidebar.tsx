    ...
    <aside className="space-y-6">
      <Card className="border-[var(--border-subtle)] bg-[var(--surface-1)]">
        <CardHeader className="border-b border-[var(--border-subtle)] px-5 py-4">
          ...
          <CardDescription>Metricas secundarias para decidir con mas contexto.</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-3 p-5">
          <MiniMetric label="Documentos" value={String(syncStats.totalDocuments)} />
          <MiniMetric label="Activos" value={String(syncStats.activeContributors)} />
          <MiniMetric label="No habidos" value={String(syncStats.noHabidoContributors)} />
        </CardContent>
      </Card>
      ...
      <Card className="border-[var(--border-subtle)] bg-[var(--surface-1)]">
        <CardHeader className="border-b border-[var(--border-subtle)] px-5 py-4">
          ...
          <CardDescription>Eventos que impactan el control regulatorio.</CardDescription>
        </CardHeader>
