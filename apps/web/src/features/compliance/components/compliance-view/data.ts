...
export const COMPLIANCE_ACTIONS: readonly ComplianceActionItem[] = [
  ...
  },
  {
    ...
    summary: 'El validador detecto incidencias con codigo SUNAT y soporte disponible.',
    detail:
    ...
    impact: 'Reduce retrabajo documental y acelera la regularizacion del periodo.',
  },
  {
    id: 'sire-difference',
...
export const COMPLIANCE_ACTIVITY: readonly ComplianceActivityItem[] = [
  ...
  },
  {
    ...
    detail: 'La propuesta de marzo ya esta alineada con el dataset demo del backend.',
    tone: 'success',
  },
];
