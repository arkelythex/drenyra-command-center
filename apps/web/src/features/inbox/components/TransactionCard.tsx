...
import type { Transaction } from "../hooks/useInbox";
			...
			<CardContent className="p-0">
				<div className="flex flex-col sm:flex-row">
					<div className="flex-1 p-8 space-y-8">
							...
							<div className="space-y-1.5">
								...
								<div className="flex items-center gap-3 text-label font-bold text-muted-foreground uppercase tracking-widest">
									<span className="flex items-center gap-1.5">
										<FileText size={12} /> CPE ELECTRÓNICO
									</span>
						...
						<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
								...
								<div className="group/select flex cursor-pointer items-center gap-4 rounded-2xl border border-border bg-muted/30 p-4 transition-[background-color,border-color,box-shadow,transform] duration-200 hover:border-foreground/30">
									<div className="flex-1 min-w-0">
										...
										<p className="text-label font-mono font-bold text-muted-foreground mt-1">
											Cuenta: {transaction.suggestedCode}
										</p>
									</div>
									<ChevronDown
										size={16}
										className="text-muted-foreground group-hover/select:text-foreground"
									/>
								</div>
							</div>
							...
							<div className="lg:col-span-5 flex justify-end">
								<Button
									size="lg"
									className="h-14 w-full bg-foreground text-background shadow-xl transition-[background-color,box-shadow,transform,opacity] duration-200 hover:bg-foreground/90 lg:w-48"
						...
						<div className="pt-6 border-t border-border/50 flex items-start gap-4">
							...
							<div className="space-y-1">
								<p className="text-label font-black uppercase tracking-widest text-foreground">
									Razonamiento
								</p>
								<p className="text-sm text-muted-foreground leading-relaxed font-medium">
									Gasto recurrente identificado. No se detectan anomalías en el
					...
					<div className="bg-muted/10 border-t sm:border-t-0 sm:border-l border-border/50 p-4 flex flex-row sm:flex-col gap-2 justify-center sm:w-16 items-center">
						<button
							aria-label="Mensaje"
							className="btn-soft p-2 text-muted-foreground transition-[background-color,color,border-color,box-shadow,transform] duration-200 hover:text-foreground"
						>
