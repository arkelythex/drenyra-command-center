...
import { inventoryApi, type InventoryListFilters, type InventoryKardexFilters } from './inventory.api'
...
export function inventoryKardexQueryOptions(productId: string, filters: InventoryKardexFilters) {
  return queryOptions({
