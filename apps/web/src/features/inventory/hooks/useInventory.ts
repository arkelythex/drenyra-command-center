...
const MOCK_STOCK = [
	...
	},
	{
		id: "3",
		sku: "PRN-004",
		name: "Impresora Epson L3150",
		stock: 5,
		unit: "UND",
		lastMovement: "2026-06-08",
		status: "critical",
	},
	{
		id: "4",
...
const MOCK_ALERTS = [
	{
		productName: "Impresora Epson L3150",
		severity: "HIGH",
		daysUntilStockout: 2,
		consumptionRate: 15,
	},
...
export const useInventory = () => {
	...
	const formattedMetrics = {
		totalValorization: summary ? n(Number(summary.totalValue || 0)) : n(0),
		rotationRate: "1.2x",
	};
