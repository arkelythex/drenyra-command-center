...
export const SmartProcurement = () => {
  return (
    <div className="flex-1 bg-card border border-border/40 shadow-sm p-8 relative overflow-hidden group" style={{ borderRadius: '2rem' }}>
      {/* Background Ambience */}
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <h3 className="text-xl font-black uppercase tracking-tight mb-3 text-foreground">Sugerencia de Compra</h3>
        
        <p className="text-sm font-medium text-muted-foreground leading-relaxed mb-8 flex-1">
          Basado en tu rotación histórica y tiempos de entrega, deberías reponer <span className="text-foreground font-black border-b-2 border-primary/30 pb-0.5">Cableado Estructurado</span> antes del viernes.
        </p>
