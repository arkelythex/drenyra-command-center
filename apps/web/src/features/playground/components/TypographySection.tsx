...
const TYPE_SCALES: TypeScale[] = [
  { token: '--text-xs', label: 'Extra Small', sample: 'The quick brown fox', weight: '400' },
  { token: '--text-sm', label: 'Small', sample: 'The quick brown fox', weight: '400' },
  { token: '--text-base', label: 'Base', sample: 'The quick brown fox', weight: '400' },
  { token: '--text-lg', label: 'Large', sample: 'The quick brown fox', weight: '500' },
  { token: '--text-xl', label: 'XL', sample: 'The quick brown fox', weight: '600' },
  { token: '--text-2xl', label: '2XL', sample: 'The quick brown fox', weight: '700' },
  { token: '--text-3xl', label: '3XL', sample: 'The quick brown fox', weight: '700' },
  { token: '--text-4xl', label: '4XL', sample: 'The quick brown fox', weight: '800' },
  { token: '--text-5xl', label: '5XL', sample: 'The quick brown', weight: '900' },
  { token: '--text-display-sm', label: 'Display SM', sample: 'Display Text', weight: '900' },
  { token: '--text-display-md', label: 'Display MD', sample: 'Display Text', weight: '900' },
  { token: '--text-display-lg', label: 'Display LG', sample: 'Display', weight: '900' },
]
...
export function TypographySection() {
  ...
  return (
    <section id="typography" className="scroll-mt-20">
      <h2 className="n text-2xl font-bold tracking-tight text-[var(--text-primary)] mb-6">Typography</h2>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] p-5">
            <span className="text-xs font-mono text-[var(--text-muted)] mb-2 block">font-sans (Inter / Geist)</span>
          ...
          <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] p-5">
            <span className="text-xs font-mono text-[var(--text-muted)] mb-2 block">font-mono (JetBrains Mono)</span>
      ...
      <div className="mb-6">
        ...
        <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <p className="text-xs text-[var(--text-muted)] mb-2">With tabular-nums (✓)</p>
            ...
            <div>
              <p className="text-xs text-[var(--text-muted)] mb-2">Without tabular-nums</p>
