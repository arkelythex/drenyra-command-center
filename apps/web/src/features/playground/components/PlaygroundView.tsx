...
import { ACCENT_PRESETS, useThemeSwitcher } from "../hooks/use-theme-switcher";
...
export function PlaygroundView() {
	...
	const { accent, mode, density, setAccent, toggleMode, setDensity } =
		useThemeSwitcher();
		...
		<div className="flex h-full">
			...
			<aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-[var(--border-subtle)] bg-[var(--color-bg-1)]">
				<div className="px-5 py-6">
					<h1 className="n text-lg font-bold tracking-tight text-[var(--text-primary)]">
						Playground
					</h1>
				...
				<div className="mx-auto max-w-5xl px-6 py-8">
					...
					<div className="mb-10">
						...
						<p className="text-sm text-[var(--text-secondary)] max-w-2xl">
							Explore the ARKELYTHEX design system. Switch between dark and
							light modes, try all 8 accent presets, and preview the complete
							component library with live CSS variable inspection.
						</p>
					</div>
			...
			{showFloating && (
				<div className="fixed bottom-6 right-6 z-50 w-64">
					<div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)]/80  p-4 shadow-lg">
								...
								<div className="flex gap-1">
									{ACCENT_PRESETS.map((preset) => (
										<button
											...
											style={{
												backgroundColor:
													accentSwatches[preset] || "var(--color-accent)",
											}}
