          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm leading-relaxed text-foreground/80">
                Hay un cargo de <strong className="rounded bg-muted px-1 py-0.5 font-mono text-foreground">S/ 50.00</strong> en el extracto que aún no figura en el libro auxiliar.
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              >
                Crear asiento <ArrowRight size={12} className="ml-2" strokeWidth={2.5} />
              </Button>
            </div>
          </div>
        </Card>
