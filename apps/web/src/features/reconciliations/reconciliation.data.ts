...
export const RECONCILIATION_TRANSACTIONS: readonly ReconciliationTransaction[] = [
    ...
    candidates: [
      {
        ...
        sourceRecords: ["Extracto BCP 14 ENE", "Asiento AST-l2", "Invoice collection batch 0314"],
        impact: "Al aprobar, el ingreso queda conciliado y sale de la cola del cierre.",
        proposedDiff: [
    ...
    candidates: [
      {
        ...
        amount: -50,
        score: 74,
        rationale: "Monto coincide, pero falta soporte documental y la glosa bancaria es ambigua.",
        sourceRecords: ["Extracto BCP 14 ENE", "Asiento AST-l3"],
        impact: "Si se aprueba sin soporte, la comisión queda conciliada pero sin evidencia completa.",
        proposedDiff: [
  ...
  },
  {
    ...
    status: "unmatched",
    confidence: 42,
    notes: "No hay match confiable. Requiere búsqueda manual o creación de asiento.",
    candidates: [
      {
        id: "c-b4-l4",
        ledgerEntryId: "l4",
        ...
        amount: -320.1,
        score: 42,
        rationale: "Monto cercano, pero la entidad legal no coincide con suficiente confianza.",
        sourceRecords: ["Extracto BCP 13 ENE", "Asiento AST-l4"],
        impact: "No se recomienda autoaprobar. Puede generar conciliación incorrecta.",
        proposedDiff: [
