...
import { STORAGE_KEY, AGENT_OPTIONS, DENSITY_OPTIONS, MAX_MESSAGES_OPTIONS } from "./SettingsPanel.data";
...
export function SettingsPanel({
  ...
  return (
    <aside
      className={cn(
        "absolute right-0 top-0 z-50 h-full w-80 border-l border-[var(--border-subtle)] bg-[var(--surface-1)]/98 backdrop-blur-xl transition-all duration-300 ease-in-out",
        isOpen
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <RadioGroup
                    ...
                    onChange={(v) =>
                      update({
                        defaultDensity: v as CommandCenterSettings["defaultDensity"],
                      })
                    }
                  />
                </div>
