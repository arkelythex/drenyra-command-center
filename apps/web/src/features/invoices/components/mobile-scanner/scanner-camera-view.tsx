    ...
    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/85 via-background/35 to-transparent p-6">
      <div className="flex items-center justify-center gap-4">
        <Button
          ...
          className="min-h-[44px] min-w-[44px] rounded-full border-background/30 bg-background/20 text-background backdrop-blur-sm transition-[background-color,border-color,color] hover:bg-background/30"
        >
        ...
        <Button
          ...
          className={cn(
            'min-h-[44px] min-w-[44px] rounded-full border-background/30 bg-background/20 text-background backdrop-blur-sm transition-[background-color,border-color,color] hover:bg-background/30',
            flashlight && 'border-yellow-500/30 bg-yellow-500/20 text-yellow-50',
          )}
        >
