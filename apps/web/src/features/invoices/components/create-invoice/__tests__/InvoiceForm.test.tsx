...
describe('InvoiceForm', () => {
  ...
  it('renders form sections and delegates to child components', async () => {
    ...
    expect(await screen.findByTestId('customer-selector-mock')).toBeInTheDocument();
    expect(await screen.findByTestId('invoice-date-fields-mock')).toBeInTheDocument();
    expect(await screen.findByTestId('line-items-mock')).toBeInTheDocument();
    expect(await screen.findByTestId('invoice-totals-mock')).toBeInTheDocument();
