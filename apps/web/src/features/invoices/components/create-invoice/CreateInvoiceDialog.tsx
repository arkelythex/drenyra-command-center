...
export const CreateInvoiceDialog = ({ open, onOpenChange, onSubmit, companyId }: CreateInvoiceModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-5xl overflow-y-auto border-border/50 bg-background/95 p-0 shadow-xl shadow-[0_0_18px_rgba(var(--premium-info-rgb),0.04)] backdrop-blur-md">
        <div className="sticky top-0 z-50 flex items-center gap-4 border-b border-border/50 bg-background/90 px-8 py-6 backdrop-blur-md">
          ...
          <DialogHeader>
            <DialogTitle className="text-2xl font-black text-foreground uppercase tracking-tighter flex flex-col">
              <span className="text-label text-muted-foreground tracking-[0.3em] font-medium mb-0.5">Módulo de Facturación</span>
              NUEVA FACTURA
            </DialogTitle>
