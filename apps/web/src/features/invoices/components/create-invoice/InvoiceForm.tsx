				...
				<div className="col-span-12 lg:col-span-4 space-y-4">
					...
					<div className="relative group">
						...
						<select
							...
							className="relative h-14 w-full cursor-pointer appearance-none rounded-2xl border border-border bg-card/80 px-6 font-mono text-label font-black text-foreground shadow-md shadow-black/5  transition-[background-color,border-color,box-shadow,color] focus:outline-none focus:border-primary/50 hover:bg-card"
						>
				...
				<div className="space-y-4">
					...
					<div className="relative group">
						...
						<select
							...
							onChange={(e) =>
								actions.setCurrency(e.target.value as InvoiceCurrency)
							}
							className="relative h-14 w-full cursor-pointer appearance-none rounded-2xl border border-border bg-card/80 px-6 font-mono text-label font-black text-foreground shadow-md shadow-black/5  transition-[background-color,border-color,box-shadow,color] focus:outline-none focus:border-[rgba(var(--premium-success-rgb),0.50)] hover:bg-card"
						>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-8">
				<div className="space-y-4">
					...
					<Textarea
						...
						className="h-full min-h-[180px] resize-none rounded-2xl border-border bg-card/80 p-6 font-sans text-sm font-medium leading-relaxed shadow-md shadow-black/5  transition-[background-color,border-color,box-shadow,color] focus:border-primary/40 placeholder:text-muted-foreground/70"
					/>
				</div>
				<Suspense
					fallback={<InvoiceFormSectionSkeleton className="min-h-[320px]" />}
				>
				...
				>
					{formState.isPending ? (
						...
						<span className="flex items-center gap-4">
							<Save size={16} strokeWidth={3} /> Confirmar y Emitir
						</span>
					)}
				</Button>
			</div>
