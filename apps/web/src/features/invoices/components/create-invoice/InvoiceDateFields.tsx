			...
			<div className="space-y-4 flex flex-col">
				...
				<div className="relative group">
					<Input
						...
						className="h-14 rounded-2xl border-border bg-card/80 px-6 font-mono text-label font-black text-foreground shadow-md shadow-black/5  transition-[background-color,border-color,box-shadow,color] hover:bg-card hover:border-primary/30"
			...
			<div className="space-y-4 flex flex-col">
				...
				<div className="relative group">
					<Input
						...
						className="h-14 rounded-2xl border-border bg-card/80 px-6 font-mono text-label font-black text-foreground shadow-md shadow-black/5  transition-[background-color,border-color,box-shadow,color] hover:bg-card hover:border-[rgba(var(--premium-info-rgb),0.30)]"
