...
export const InvoiceTotals = ({ totals, currency }: Props) => {
	return (
		<div className="relative group/totals overflow-hidden">
			...
			<div className="relative space-y-8 rounded-2xl border border-border bg-card/70 p-10 shadow-xl shadow-black/8 ">
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-4">
						...
						<div className="flex flex-col">
							<span className="text-label uppercase tracking-[0.25em] font-black text-foreground/80">
								Liquidación Final
							</span>
							<span className="text-xs text-muted-foreground/50 font-bold uppercase tracking-widest">
								Resumen Impositivo Estándar
							</span>
						</div>
					</div>
				...
				<div className="relative py-2">
					...
					<div className="relative flex justify-center">
						<div className="bg-card/80  px-4 py-1 rounded-full border border-border/40 shadow-sm">
				...
				<div className="flex justify-between items-end pt-2">
					<div className="flex flex-col gap-1">
						<span className="text-sm font-black uppercase tracking-[0.3em] text-[var(--premium-action-cyan)]">
							Total Neto a Pagar
						</span>
						<span className="text-xs text-muted-foreground/40 font-bold uppercase tracking-widest">
							Monto expresado en {currency === "PEN" ? "Soles" : "Dólares"}
						</span>
					</div>
				...
				<div className="pt-4 border-t border-border/20 flex items-center justify-center gap-6">
					<div className="flex cursor-help items-center gap-2 grayscale brightness-150 opacity-20 transition-[opacity,filter] duration-300 hover:opacity-100 hover:grayscale-0">
						...
						<span className="text-2xs font-black uppercase tracking-tighter">
							ARKELYTHEX CORE
						</span>
					</div>
					<div className="flex cursor-help items-center gap-2 grayscale brightness-150 opacity-20 transition-[opacity,filter] duration-300 hover:opacity-100 hover:grayscale-0">
