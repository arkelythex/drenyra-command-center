		...
		>
			<div className="flex items-center justify-between mb-6 px-3">
				<div className="flex items-center gap-3">
					<div
						className={cn(
							...
							isOver &&
								"bg-primary shadow-[0_0_12px_rgba(var(--primary),0.8)] scale-150",
						)}
					/>
					<span
						className={cn(
				...
				<div className="flex items-center gap-2 font-mono">
					<span className="rounded border border-border/60 bg-muted/60 px-2 py-0.5 text-label font-black text-foreground ">
						{count}
					</span>
					{total && (
						<span className="rounded border border-border/60 bg-muted/60 px-2 py-0.5 text-label font-bold tabular-nums text-foreground ">
							{total}
						</span>
					)}
				</div>
