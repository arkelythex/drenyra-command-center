...
export function SendEmailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/45 backdrop-blur-sm">
      <LiquidGlass intensity="medium" className="mx-4 w-full max-w-md overflow-hidden rounded-2xl border-border/60 p-0 shadow-xl">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-border/60 bg-muted/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className={cn("text-lg font-black uppercase tracking-tight text-foreground", LEGIBILITY.textShadow.light)}>
                Enviar Factura
              </h2>
        ...
        <div className="p-6 space-y-6">
          {/* Recipient */}
          <div>
            <label className={cn("block text-2xs font-black uppercase tracking-[0.2em] text-muted-foreground mb-2 pl-1", LEGIBILITY.textShadow.light)}>
              Destinatario
            </label>
            <div className="px-4 py-3 bg-muted/60 border border-border/60 rounded-xl backdrop-blur-sm shadow-inner">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-border/60 bg-muted/60 px-4 py-3 text-xs font-medium text-foreground backdrop-blur-sm transition-[background-color,border-color,box-shadow,color] placeholder:text-muted-foreground/70 focus:outline-none focus:border-primary/40"
              rows={4}
            />
          </div>
