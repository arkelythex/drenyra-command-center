		...
		<div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
				...
				<button
					type="button"
					onClick={onOpenAddModal}
					className=" bg-card/70 border-2 border-dashed border-white/20 rounded-xl p-6 hover:bg-muted/70 hover:border-primary/50 transition-all group min-h-[200px] flex flex-col items-center justify-center"
				>
