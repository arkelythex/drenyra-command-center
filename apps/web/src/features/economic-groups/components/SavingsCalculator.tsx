    ...
    <div className="space-y-6">
      ...
      <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          {/* CONCAR */}
          <div className="backdrop-blur-xl bg-surface-3 border border-stroke-1 rounded-xl p-4">
          ...
          {/* ARKELYTHEX */}
          <div className="backdrop-blur-xl bg-surface-2 border-2 border-info-subtle rounded-xl p-4 relative">
        ...
        <div className="mt-6 backdrop-blur-xl bg-surface-2 border border-stroke-2 rounded-xl p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-black text-info">{savings.percentConcar}%</p>
            </div>
          </div>
        </div>
      </div>
