export const dashboardKeys = {
	...
	overview: (companyId: string) =>
		[...dashboardKeys.overviews(), companyId] as const,
	summaries: () => [...dashboardKeys.all, "summary"] as const,
	summary: (companyId: string) =>
		[...dashboardKeys.summaries(), companyId] as const,
	income: (companyId: string) =>
		[...dashboardKeys.all, "income", companyId] as const,
	expenses: (companyId: string) =>
		[...dashboardKeys.all, "expenses", companyId] as const,
