    ...
    <CommandDeck>
       ...
       <DeckItem
         ...
         onClick={() => {
           ...
           const event = new CustomEvent('quickAction', { detail: { action: 'new-transaction' } });
       ...
       <DeckItem
         ...
         onClick={() => {
           ...
           const event = new CustomEvent('quickAction', { detail: { action: 'generate-report' } });
           window.dispatchEvent(event);
         }}
         label="Reporte"
       />
       <DeckItem
         ...
         onClick={() => {
           ...
           const event = new CustomEvent('quickAction', { detail: { action: 'export-data' } });
           window.dispatchEvent(event);
         }}
         label="Exportar"
       />
