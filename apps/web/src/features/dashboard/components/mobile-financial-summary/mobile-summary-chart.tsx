    ...
    <div className="relative mt-4 px-6 py-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="ui-card-surface rounded-lg px-3 py-1">
          <span className="text-2xs font-semibold uppercase tracking-[0.08em] text-[var(--premium-text-secondary)]">Live</span>
        </div>
      </div>
      ...
      <div className="relative h-48 w-full">
        ...
        <svg className="absolute inset-0 h-full w-full pl-12" viewBox="0 0 100 100" preserveAspectRatio="none">
          <defs>
            <filter id="premium-line-glow" x="-20%" y="-20%" width="140%" height="140%">
              <feDropShadow dx="0" dy="0" stdDeviation="1.8" floodColor="rgba(185,122,69,0.35)" floodOpacity="0.35" />
            </filter>
          </defs>
