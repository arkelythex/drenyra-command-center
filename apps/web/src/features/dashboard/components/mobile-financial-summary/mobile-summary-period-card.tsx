...
export function MobileSummaryPeriodCard() {
	return (
		<div className="relative z-20 -mt-12 px-6">
			<SurfacePanel padding="lg" className="relative rounded-xl">
				...
				<div className="mb-6">
					<Text
						variant="label"
						className="mb-2 block uppercase tracking-[0.14em] text-[var(--premium-text-secondary)]"
					>
						Periodo Fiscal
					</Text>
				...
				<div className="space-y-6">
					<div className="space-y-4">
						<div className="flex items-center gap-2">
							...
							<Text
								variant="label"
								className="uppercase tracking-[0.12em] text-[var(--premium-text-secondary)]"
							>
								Proyectado
							</Text>
						</div>
					...
					<div className="flex items-center justify-between border-t border-white/5 pt-6">
						<div className="flex flex-col gap-0.5">
							<Text
								variant="label"
								className="uppercase tracking-[0.12em] text-[var(--text-tertiary)]"
							>
								Desviacion
							</Text>
							<Text
								variant="data"
								className="text-2xl text-[var(--color-sunat-success)]"
							>
								11.5%
							</Text>
						</div>
