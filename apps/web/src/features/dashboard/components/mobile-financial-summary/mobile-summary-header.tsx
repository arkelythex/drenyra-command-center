...
export function MobileSummaryHeader({
	tabs,
	activeTab,
	onTabChange,
}: MobileSummaryHeaderProps) {
	return (
		<div className="space-y-7 px-6 pb-6 pt-14">
			<div className="flex items-center justify-between">
				<div className="flex flex-col gap-1">
					...
					<div className="flex items-center gap-2.5">
						...
						<Text
							variant="body"
							className="text-[12px] font-bold uppercase tracking-tight text-foreground"
						>
							Operación activa
						</Text>
					</div>
			...
			<div className="glass-panel flex items-center justify-between rounded-3xl border-border/40 bg-card/55 p-1.5 ">
				{tabs.map((tab) => (
					<button
						type="button"
						key={tab}
