      ...
      <div className="flex flex-col items-center">
        <div className="relative flex h-48 w-48 items-center justify-center">
          ...
          <svg className="h-48 w-48 -rotate-90" viewBox="0 0 192 192" aria-hidden="true">
            <defs>
              <linearGradient id="premium-score-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <circle cx="96" cy="96" r="78" fill="none" stroke="#0E0A08" strokeWidth="12" />
            <circle
              cx="96"
              cy="96"
              r="78"
              ...
              style={{
                filter: 'drop-shadow(0 0 12px rgba(var(--premium-info-rgb),0.42))',
          ...
          <div className="relative flex flex-col items-center">
            <span className="text-6xl font-semibold tracking-[-0.02em] text-[var(--premium-text-primary)]">{scoreValue}</span>
            <div className="ui-card-surface mt-2 rounded-full px-4 py-1">
              <span className="text-2xs font-semibold uppercase tracking-[0.08em] text-[var(--premium-action-cyan)]">{scoreLabel}</span>
            </div>
          </div>
        </div>
      </div>
