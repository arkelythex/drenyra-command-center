...
vi.mock('../MobileFinancialSummary', () => ({
  MobileFinancialSummary: () => <div data-testid="mobile-financial-summary-mock" />,
}));
...
describe('DashboardView', () => {
  ...
  it('keeps mobile-only dashboard code out of the desktop render path', () => {
    ...
    expect(screen.queryByTestId('mobile-financial-summary-mock')).not.toBeInTheDocument();
  });
  ...
  it('renders the mobile summary path only for mobile viewports', async () => {
    ...
    expect(await screen.findByTestId('mobile-financial-summary-mock')).toBeInTheDocument();
    expect(screen.queryByTestId('dashboard-header-mock')).not.toBeInTheDocument();
  });
  ...
  it('loads optional scanner and invite surfaces only when opened', async () => {
    ...
    expect(await screen.findByTestId('invite-member-modal-mock')).toBeInTheDocument();
    expect(await screen.findByTestId('mobile-invoice-scanner-mock')).toBeInTheDocument();
  });
});
