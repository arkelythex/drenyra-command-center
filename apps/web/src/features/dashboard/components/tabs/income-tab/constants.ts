...
export const INCOME_FALLBACK: DashboardIncomeResponse = {
  ...
  topCustomers: [
    { customerId: 'fallback-c1', customerName: 'Corp Logística del Perú', total: 28_000, invoiceCount: 4 },
    { customerId: 'fallback-c2', customerName: 'Inmobiliaria Interamericana', total: 22_500, invoiceCount: 3 },
    { customerId: 'fallback-c3', customerName: 'Transportes Rápidos Sur', total: 13_600, invoiceCount: 2 },
  ],
};
