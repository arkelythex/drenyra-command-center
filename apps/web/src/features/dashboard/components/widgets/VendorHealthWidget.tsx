...
const MOCK_CRITICAL_VENDORS = [
	{
		...
		ruc: "20100000001",
		status: "Baja de Oficio",
		amount: 2100.0,
	},
	{
		id: "2",
		name: "SERVICIOS GENERALES E.I.R.L.",
		ruc: "20555555555",
		status: "No Habido",
		amount: 2400.0,
	},
...
export const VendorHealthWidget: React.FC = () => {
	const totalRisk = MOCK_CRITICAL_VENDORS.reduce(
		...
		<section className="space-y-4" aria-label="Riesgo de proveedores">
			...
			<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
				{MOCK_CRITICAL_VENDORS.map((vendor) => (
					<Card
						key={vendor.id}
						className="rounded-2xl border border-border/50 bg-[var(--surface-1)]/84 shadow-sm"
					>
