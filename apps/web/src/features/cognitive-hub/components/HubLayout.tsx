...
const HubRightRailContainer = React.lazy(() =>
	import("./layout/hub-right-rail-container").then((m) => ({
		default: m.HubRightRailContainer,
	})),
);
...
const HubChatSkeleton = ({ density }: { density: "compact" | "normal" }) => (
	<div className={density === "compact" ? "space-y-4 p-6" : "space-y-6 p-8"}>
...
const HubRightRailSkeleton = () => (
	<aside className="ui-agent-history-panel hidden w-[340px] shrink-0 border-l border-[var(--border-subtle)] bg-[var(--surface-1)] xl:flex"></aside>
);
