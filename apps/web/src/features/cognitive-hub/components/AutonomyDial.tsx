...
const levels = [
	...
	},
	{
		...
		label: "COLABORADOR",
		icon: Shield,
		desc: "Ejecuta con confirmación doble.",
		color: "text-[var(--premium-action-cyan)]",
	},
	{
		id: 3,
		label: "CO-PILOTO",
		icon: Bot,
		desc: "Prepara acciones y solicita confirmación.",
	...
	},
	{
		...
		label: "SUPERVISADO",
		icon: Cpu,
		desc: "Ejecuta solo dentro de compuertas aprobadas.",
		color: "text-[var(--premium-action-cyan)]",
	},
	{
		id: 5,
		label: "REVIEW-GATED",
		icon: ClipboardCheck,
		desc: "Propone cambios críticos y exige aprobación humana.",
		color: "text-amber-300",
	},
];

export const AutonomyDial = ({
	currentLevel,
	onLevelChange,
}: AutonomyDialProps) => {
