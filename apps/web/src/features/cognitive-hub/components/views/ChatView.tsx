      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-2 pt-1">
            <span className="text-2xs font-black uppercase text-primary tracking-widest">Respuesta Enjambre</span>
            <p className="text-sm text-foreground leading-relaxed rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-2)] p-4 shadow-inner">
              Tu ratio de liquidez actual es de **1.45**. Esto es un 12% superior al mes pasado. 
              Sin embargo, detecto un pago de detracción de **S/ 12,400** programado para el día 20 que podría estresar tu flujo de caja.
            </p>
          </div>
        </div>
      </div>
