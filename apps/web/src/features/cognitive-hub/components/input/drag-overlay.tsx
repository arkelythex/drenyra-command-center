    ...
    <AnimatePresence>
      {isVisible ? (
        <motion.div
          ...
          className="pointer-events-none absolute inset-0 z-50 flex items-center justify-center rounded-xl border border-border/70 bg-background/55 p-4 backdrop-blur-lg"
        >
