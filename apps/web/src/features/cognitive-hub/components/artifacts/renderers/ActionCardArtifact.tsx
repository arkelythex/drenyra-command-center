...
export const ActionCardArtifact: React.FC<{ artifact: ActionCardArt }> = ({ artifact }) => {
  return (
      ...
      <div className="space-y-5 p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-base font-black uppercase tracking-tight antialiased text-foreground">{artifact.title}</h4>
              <div className="flex items-center gap-2 mt-0.5">
                <div className="h-1.5 w-1.5 rounded-full bg-info animate-pulse" />
                <p className="text-3xs text-muted-foreground font-black uppercase tracking-widest">Validación de decisión</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 rounded-lg border border-border/70 bg-background/50 p-4 font-mono text-2xs">
          <div className="space-y-2">
            <span className="text-muted-foreground uppercase tracking-widest">Estado actual</span>
          ...
          <div className="space-y-2 border-l border-border/40 pl-4">
            <span className="font-black uppercase tracking-widest text-foreground/70">Proyectado</span>
            <div className="flex justify-between items-baseline border-b border-border/40 pb-1">
              <span className="text-muted-foreground">Liquidez</span>
