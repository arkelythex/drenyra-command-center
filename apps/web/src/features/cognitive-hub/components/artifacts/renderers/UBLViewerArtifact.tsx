...
export const UBLViewerArtifact: React.FC<UBLViewerArtifactProps> = ({
	artifact,
}) => {
			...
			<div className="flex flex-col border-b border-[var(--border-subtle)] bg-[var(--surface-2)] p-4">
					...
					<div className="flex items-center gap-3">
						...
						<div>
							<h3 className="text-sm font-bold text-[var(--text-primary)]">
								Factura Electrónica F001-00001234
							</h3>
				...
				<div className="mt-4 grid grid-cols-3 gap-3">
					<div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] p-2.5">
						<span className="block text-2xs font-bold uppercase tracking-wider text-[var(--text-tertiary)]">
							Emisor
						</span>
						<span className="mt-1 block truncate text-xs font-semibold">
							20123456789
						</span>
						<span className="block truncate text-2xs text-[var(--text-secondary)]">
					...
					<div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] p-2.5">
						...
						<span className="mt-1 block text-xs font-bold text-[var(--color-success)]">
							S/ 1,500.00
						</span>
						<span className="block text-2xs text-[var(--text-secondary)]">
							Inc. IGV (18%)
						</span>
					</div>
				</div>
