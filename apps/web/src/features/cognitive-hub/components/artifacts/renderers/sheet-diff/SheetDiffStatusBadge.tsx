  ...
  return (
    <span
      className={cn(
        ...
        status === 'updated' && 'border-[rgba(var(--premium-success-rgb),0.30)] bg-[rgba(var(--premium-success-rgb),0.10)] text-[var(--premium-success)]',
        status === 'flagged' && 'border-amber-500/30 bg-amber-500/10 text-amber-500',
        status === 'unchanged' && 'border-border/50 bg-background/60 text-muted-foreground',
      )}
    >
