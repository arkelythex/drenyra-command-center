...
export const HubArtifactAside = ({ activeArtifact, onClose }: HubArtifactAsideProps) => {
		...
		<div className="flex h-full flex-col">
			<header className="flex h-16 shrink-0 items-center justify-between px-6">
				<div className="flex items-center gap-3">
					...
					<div className="flex flex-col">
						<span className="text-xs font-bold uppercase tracking-widest text-muted">Artefacto</span>
			...
			<div className="flex-1 overflow-y-auto px-6 pb-6 scrollbar-none">
				<div className="rounded-2xl border border-white/5 bg-white/5 p-1 shadow-inner">
					<div className="rounded-[14px] bg-background/40 p-4 backdrop-blur-md">
