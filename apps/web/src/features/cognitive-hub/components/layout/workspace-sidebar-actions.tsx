...
export function WorkspaceSidebarActions({ isCollapsed, onNavigate }: WorkspaceSidebarActionsProps) {
  ...
  return (
    <section className="space-y-2.5">
      {!isCollapsed ? (
        <p className="px-1 text-label font-medium text-muted-foreground">Acciones</p>
      ) : null}
      ...
      >
        ...
        {!isCollapsed ? (
          <span className="text-sm font-medium text-foreground">Nuevo cierre</span>
        ) : null}
      </button>
    </section>
  );
