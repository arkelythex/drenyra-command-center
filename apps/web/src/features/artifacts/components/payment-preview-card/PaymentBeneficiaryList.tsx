...
export function PaymentBeneficiaryList({
	...
	return (
		<div className="rounded-2xl border border-border bg-card/70 p-4">
			<h4 className="mb-2 text-label font-black uppercase tracking-widest text-foreground">
				Beneficiarios
			</h4>
			<p className="mb-3 text-3xs font-black uppercase tracking-wider text-primary/70">
				↑↓ fila | Cmd/Ctrl+K editar | Cmd/Ctrl+Enter aplicar
			</p>
					...
					return (
						<PaymentBeneficiaryItem
							...
							onPromptChange={(prompt) =>
								onPromptChange(beneficiary.id, prompt)
							}
