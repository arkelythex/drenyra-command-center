...
export function SireDiffSummaryGrid({
	period,
	currency,
	summary,
}: SireDiffSummaryGridProps) {
	return (
		<div className="grid grid-cols-1 gap-3 md:grid-cols-6">
			...
			<SummaryCard
				...
				valueClassName="text-[var(--premium-success)]"
			/>
			<SummaryCard
				label="Mismatch"
			...
			/>
			<SummaryCard
				label="Faltante Local"
				value={summary.missingOnLedger}
				valueClassName="text-red-500"
			/>
			<SummaryCard
				label="Faltante SUNAT"
				value={summary.missingOnSunat}
				valueClassName="text-red-500"
			/>
			<SummaryCard
				label="Brecha"
