...
import { FiscalEditorialShell } from "./FiscalEditorialShell";
import { Sidebar } from "./Sidebar";

const TerminalShell = lazy(() =>
	import("../agentic/TerminalShell").then((m) => ({
...
export function CodexShell(_props: CodexShellProps) {
	...
	return (
		<FiscalEditorialShell mode="command-center" className="pb-14 lg:pb-0">
			...
			<div className="flex min-h-0 flex-1">
				...
				{rightPanelOpen && (
					// biome-ignore lint/a11y/noStaticElementInteractions: mobile panel dismiss overlay
					<div
