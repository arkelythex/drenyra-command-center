import { Clock, FileDiff, History, RotateCcw, X } from "lucide-react";
...
export function CheckpointHistory({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: modal dismiss overlay
		<div
			...
			>
				...
				<div className="flex items-center justify-between border-b border-[var(--border-subtle)] px-5 py-4">
					<div className="flex items-center gap-2">
						...
						<h2 className="n text-base font-semibold text-[var(--text-primary)]">
				...
				<div className="flex-1 space-y-3 overflow-y-auto p-5">
					{checkpoints.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-12 text-center">
							...
							<p className="n text-sm font-medium text-[var(--text-primary)]">
								Sin checkpoints
							</p>
						...
						checkpoints.map((cp) => (
							...
							>
								...
								<div className="flex items-center gap-3 text-xs text-[var(--text-muted)]">
									...
									<span className="rounded-md bg-[var(--surface-3)] px-1.5 py-0.5 font-mono text-[10px]">
										{cp.agentId}
									</span>
