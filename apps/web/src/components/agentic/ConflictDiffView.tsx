						...
						<div className="p-4 flex flex-col md:flex-row md:items-center gap-4">
							...
							<div className="flex items-center gap-3 w-full md:w-1/4">
								...
								<div className="min-w-0">
									<p className="text-2xs font-black uppercase tracking-tighter text-muted-foreground opacity-60">
										{item.label}
									</p>
							...
							<div className="flex items-center gap-4 md:w-1/5 justify-end">
								<div className="text-right">
									<p className="text-3xs font-black text-muted-foreground/40 uppercase">
										Confianza
									</p>
									<p
										className={cn(
