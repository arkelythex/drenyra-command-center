  ...
  return (
    <div className="group rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] p-4 transition-all hover:border-[var(--border-default)] hover:shadow-sm">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className={cn("flex items-center gap-1 rounded-full px-2 py-0.5 text-2xs font-medium", trendColor)}>
          <TrendIcon size={11} />
          <span>{metric.variance > 0 ? '+' : ''}{metric.variance.toFixed(1)}%</span>
        </div>
      </div>
