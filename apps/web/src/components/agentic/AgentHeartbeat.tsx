...
export const AgentHeartbeat = ({ runId }: { runId: string }) => {
  ...
  useEffect(() => {
    ...
    const eventSource = new EventSource(`http://localhost:3000/swarm/stream/${runId}`);
  ...
  return (
    <div className="glass-panel p-4 rounded-2xl flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-2xs font-black uppercase tracking-[0.2em] text-muted-foreground">Enjambre Activo</p>
